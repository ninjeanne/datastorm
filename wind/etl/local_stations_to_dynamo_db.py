# USAGE: spark-submit local_stations_to_dynamo_db.py <input_path> <table_name>
...
def etl(input_path, table_name):
    stations_input = sc.textFile(input_path)
...
if __name__ == '__main__':
    ...
    spark = SparkSession.builder.appName('local_stations_to_dynamo_db').getOrCreate()
    assert spark.version >= '3.0'
    spark.sparkContext.setLogLevel('WARN')
    sc = spark.sparkContext
    etl(input_path, table_name)
