...
def etl(inputs, outputs):
    ...
    canada_weather_data.repartition(12).write \
...
if __name__ == '__main__':
    inputs = sys.argv[1]
    outputs = sys.argv[2]
    spark = SparkSession.builder.appName('Datastorm 12p').getOrCreate()
    ...
    # s3://datastorm-data/ETL-emr-s3-12p.py
    # s3://kpd3-datastorm-cmpt732/ s3://datastorm-data/data_after_ETL-12p/