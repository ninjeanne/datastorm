...
def etl(inputs, outputs):
    ...
    canada_weather_data.repartition(1).write \
...
if __name__ == '__main__':
    inputs = sys.argv[1]
    outputs = sys.argv[2]
    spark = SparkSession.builder.appName('Datastorm 1p').getOrCreate()
    ...
    # s3://datastorm-data/ETL-emr-s3-1p.py
    # s3://kpd3-datastorm-cmpt732/ s3://datastorm-data/data_after_ETL-1p/