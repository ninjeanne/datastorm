...
def etl(inputs, outputs):
    ...
    canada_weather_data.repartition(1500).write \
...
if __name__ == '__main__':
    inputs = sys.argv[1]
    outputs = sys.argv[2]
    spark = SparkSession.builder.appName('Datastorm 1500p').getOrCreate()
    ...
    # s3://datastorm-data/ETL-emr-s3-1500p.py
    # s3://kpd3-datastorm-cmpt732/ s3://datastorm-data/data_after_ETL-1500p/